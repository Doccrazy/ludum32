...
public class EnemyActor extends ShapeActor implements CollisionListener{
	...
	public EnemyActor(Box2dWorld world, Vector2 spawn, boolean spawnIsLeftBottom) {
	...
	public void draw(com.badlogic.gdx.graphics.g2d.Batch batch, float parentAlpha) {
		...
		batch.draw(Resource.GFX.lifeBar,getX(), getY() + 1.5f, getWidth() * lives/100f, getWidth()/10f);
